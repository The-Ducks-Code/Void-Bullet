...
codes['shoptest'] = function() noticolor = {255, 0, 0, 255} noti = 'CHEAT ACTIVATED, shop test' notiTimerTrigger = true noticolor = {255, 255, 255, 255} player.round = 4 player.coins = 9999 end
