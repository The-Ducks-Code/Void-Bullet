## TODO
* Exploding bullet item
* Replace generic stat up items with flavored ones that are all slightly different
* Summoner boss
* More enemy types
* Special ability button that gets better the more ability items you get (i.e. you have one item that heals you every time you use your special ability and another that buffs your damage) implement some system to restrict the use of the ability
